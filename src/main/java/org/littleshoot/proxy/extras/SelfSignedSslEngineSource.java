...
public class SelfSignedSslEngineSource implements SslEngineSource {
    ...
    private static final String PASSWORD = "40kmonkeys";
    private static final String PROTOCOL = "TLS";
    private static final String TAG = "PROXY-" + SelfSignedSslEngineSource.class.getSimpleName();
    ...
    private void initializeKeyStore() {
        if (keyStoreFile.isFile()) {
            Log.i(TAG, "Not deleting keystore");
            return;
        }
    ...
    private String nativeCall(final String... commands) {
        Log.i(TAG, "Running '" + Arrays.asList(commands) + "'");
        ...
        try {
            ...
            final String data = total.toString();
            Log.i(TAG, "Completed native call: '" + Arrays.toString(commands) +"'\nResponse: '" + data + "'");
            return data;
        } catch (final IOException e) {
            Log.e(TAG, "Error running commands: " + Arrays.toString(commands));
            return "";
        }
    }
